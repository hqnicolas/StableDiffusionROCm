...
wget https://raw.githubusercontent.com/hqnicolas/StableDiffusionROCm/v1.7.0-RX6XT/AMD-ROCm-Drivers/prepare.sh
...
- install Docker
```
wget https://raw.githubusercontent.com/hqnicolas/StableDiffusionROCm/v1.7.0-RX6XT/docker.sh
...
```
git clone --branch v1.7.0-RX6XT https://github.com/hqnicolas/StableDiffusionROCm.git
