...
- Radeon RX-6000
Select [V1.10.1](https://github.com/hqnicolas/StableDiffusionROCm/tree/v1.10.1-RX6XT) or [V1.9.3](https://github.com/hqnicolas/StableDiffusionROCm/tree/v1.9.3-RX6XT) or [1.7.0](https://github.com/hqnicolas/StableDiffusionROCm/tree/v1.7.0-RX6XT) 
...
wget https://raw.githubusercontent.com/hqnicolas/StableDiffusionROCm/v1.10.1-RX6XT/AMD-ROCm-Drivers/prepare.sh
...
- install Docker
```
wget https://raw.githubusercontent.com/hqnicolas/StableDiffusionROCm/v1.10.1-RX6XT/docker.sh
...
```
git clone --branch v1.10.1-RX6XT https://github.com/hqnicolas/StableDiffusionROCm.git
